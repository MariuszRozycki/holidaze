...
const DisplaySelectedDates = ({ onClick }: DisplaySelectedDatesProps) => {
  ...
  const formattedStartDate = startDate ? format(startDate, "dd MMM yyyy") : "No selected start date";
  const formattedEndDate = endDate ? format(endDate, "dd MM yyyy") : "No selected end date";
